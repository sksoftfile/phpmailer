...
require_once('includexa/membersite_config.php');
    if(isset($_POST['logged'])){
    	...
    	if($fgmembersite->Login()){
    		if($_SESSION['enroll'] == "$user"){
    		$fgmembersite->RedirectToURL("termandcondition.php");
    	}
    	else{
    		echo"";
    	}
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card brdth">
                    ...
                    <div class=" text-center fntsize font-weight-bolder brdrdus">Candidate Login</div>
        ...
        <div>
         <span class='error' style="color: red;"><?php echo $fgmembersite->GetErrorMessage();?></span>
                            ...
                            <div class="form-group row">
                                <label for="email_address" class="col-md-4 col-form-label text-md-right font-weight-bold">Roll No</label>
                                <div class="col-md-6">
